...
export default function HeaderDropdown() {
	return (
		<details className="relative">
			<summary className="hover:bg-tint flex cursor-pointer list-none [&::-webkit-details-marker]:hidden items-center justify-between gap-2 rounded-[9px] px-2.5 py-[7px] transition-colors duration-[120ms]">
			...
			<div className="bg-panel border-rule-soft shadow-card-lg absolute top-full left-0 z-10 mt-2 w-full rounded-[12px] border p-1">
				<button
					type="button"
