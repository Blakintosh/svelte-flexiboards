...
export default function FlexionBlockContainer({
	...
	return (
		<FlexiWidget className={blockClass} transition={blockTransition}>
			...
			<span className="ml-auto hidden shrink-0 self-start pt-1.5 text-[11px] font-semibold text-fx-accent opacity-0 transition-opacity duration-[120ms] group-hover:opacity-100 motion-reduce:transition-none lg:block">
				Grab to reorder
			</span>
		</FlexiWidget>
	);
