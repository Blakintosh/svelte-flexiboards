	...
	return (
		<main className="bg-paper flex h-full min-h-0 w-full flex-col gap-8 px-12 py-8 lg:px-16">
			<header className="flex shrink-0 items-baseline justify-between gap-4">
				<h1 className="text-ink font-serif text-2xl lg:text-[30px]">Numbers</h1>
				<span className="text-faint text-[11.5px] font-semibold">
					3 × 3 · free grid · add and delete
				</span>
			</header>
			...
			>
				<FlexiAdd
					addWidget={addWidget}
					className={
						'ui border-rule-soft bg-stage text-faint hover:border-ink hover:bg-tint hover:text-ink flex size-32 flex-col items-center justify-center rounded-[14px] border border-dashed p-4 text-center text-xs transition-colors duration-[120ms] lg:size-40'
					}
				>
					{() => (
						<>
