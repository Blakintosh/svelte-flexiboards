...
<div
	class="border-rule bg-panel flex h-full w-full min-w-0 cursor-grab items-center gap-2 border px-2"
>
	<span class="text-faint w-3 shrink-0 font-mono text-[11px]">{position}</span>
	<span class={cn('size-1.5 shrink-0', statusClass[task.status])} aria-hidden="true"></span>
