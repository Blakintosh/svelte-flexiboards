			...
			<nav class="not-prose mt-14 grid grid-cols-2 border border-rule bg-card">
				{#if location.prev}
					<a
						...
						class="border-r border-rule p-5 no-underline transition-colors duration-[120ms] hover:text-fx-accent"
					>
				...
				{#if location.next}
					<a
						...
						class="p-5 text-right no-underline transition-colors duration-[120ms] hover:text-fx-accent"
					>
